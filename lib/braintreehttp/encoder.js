...
let MultipartRelated = require('./serializer/multipart_related').MultipartRelated;
...
class Encoder {
  ...
  constructor() {
    this._encoders = [new Json(), new Text(), new MultipartRelated(), new Multipart(), new FormEncoded()];
  }
